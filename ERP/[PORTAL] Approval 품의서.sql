...
SELECT * FROM USERS WHERE 1=1 AND USERID LIKE 'gnkim%';

SELECT * FROM USERBRAND WHERE 1=1 AND USERID = 'gnkim3';

SELECT  * FROM USERS_MODULE WHERE 1=1 AND USERID = 'gnkim3';

SELECT * FROM USERPERMISSION WHERE 1=1 AND USERID = 'gnkim3';


-- 인트라넷 품의 승인자 조회
SELECT * FROM APV_CONFIRM WHERE 1=1 AND CFM_NAME = '김규년';